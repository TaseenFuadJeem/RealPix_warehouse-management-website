...
const Footer = () => {
    return (
        <div>
            ...
            <footer className="bg-blue-600 relative bottom-0">
                ...
                <div className="py-6 px-4 bg-blue-700 md:flex md:items-center md:justify-between">
                    <span className="text-sm text-white sm:text-center">© 2022 <a href="https://flowbite.com">Taseen Fuad Jeem</a>. All Rights Reserved.
                    </span>
